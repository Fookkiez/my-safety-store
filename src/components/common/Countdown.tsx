...
const renderer2 = ({ days, hours, minutes, seconds, completed }: { days: number, hours: number, minutes: number, seconds: number, completed: boolean }) => {
  if (completed) {
...
export default function CountdownComponent({
  fullLabel = false,
  labels: labels = "Days,Hours,Mins,Secs",
